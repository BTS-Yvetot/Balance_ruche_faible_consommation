...
String HX711::get_units(byte times) {
  float poids=0.0;
  int poidsHectoGramme=0;
  String poids3chiffres="000";
  poids=(get_value(times) / SCALE);
  poidsHectoGramme=(int)poids;
  if(poidsHectoGramme<0){
    poids3chiffres="---";
  }
  if(poidsHectoGramme>=0 && poidsHectoGramme<10){
    poids3chiffres="00"+String(poidsHectoGramme);
  }
  if(poidsHectoGramme>=10 && poidsHectoGramme<100){
    poids3chiffres="0"+String(poidsHectoGramme);
  }
  if(poidsHectoGramme>=100 && poidsHectoGramme < 1000){
    poids3chiffres=String(poidsHectoGramme);
  }
  if(poidsHectoGramme>=1000){
    poids3chiffres="+++";
  }
  return poids3chiffres;
}
